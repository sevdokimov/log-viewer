...
The library is `com.logviewer:log-viewer-spring-boot:0.1.2` in https://dl.bintray.com/sevdokimov/log-viewer maven repository
...
dependencies {
    implementation 'com.logviewer:log-viewer-spring-boot:0.1.2'
}
```
  </p>
</details>
