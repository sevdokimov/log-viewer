...
The library is `com.logviewer:log-viewer-spring-boot:0.1.8` in https://maven.pkg.github.com/sevdokimov/log-viewer maven repository
...
dependencies {
    implementation 'com.logviewer:log-viewer-spring-boot:0.1.8'
}
```
  </p>
</details>
