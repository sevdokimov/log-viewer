...
public class RegexUtilsTest {
    ...
    private void checkMatches(String pattern, String ... samples) throws ParseException {
        Pattern regexp = RegexUtils.dateFormatToRegexp(pattern);
        ...
        for (String sample : samples) {
            ...
            assert regexp.matcher(sample).matches() : sample;
        }
    }
    ...
    @Test
    public void testSimpleDateFormatRegexp() throws ParseException {
