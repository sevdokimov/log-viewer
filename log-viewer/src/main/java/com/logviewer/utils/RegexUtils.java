...
public class RegexUtils {
    ...
    private static final Pattern SIMPLE_DATE_FORMAT_REGEXP = Pattern.compile("'([^']*)'|(([a-zA-Z])\\3*)");
    ...
    public static Pattern dateFormatToRegexp(String pattern) {
        StringBuilder res = new StringBuilder();
        dateFormatToRegexp(res, pattern);
        return Pattern.compile(res.toString());
    }

    public static void dateFormatToRegexp(StringBuilder res, String pattern) {
        Matcher matcher = SIMPLE_DATE_FORMAT_REGEXP.matcher(pattern);
