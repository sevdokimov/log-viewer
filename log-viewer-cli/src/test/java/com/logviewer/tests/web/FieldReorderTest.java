...
public class FieldReorderTest extends AbstractWebTestCase {
    ...
    public static final RegexLogFormat FORMAT = new RegexLogFormat(StandardCharsets.UTF_8, "num2",
            "(\\[[^\\]]+\\])\\[ *([^\\]]+)\\] (\\w+) (\\d+) (\\d+)",
            new RegexLogFormat.RegexpField("num2", 4, "number"),
            new RegexLogFormat.RegexpField("num1", 5, "number"),
            new RegexLogFormat.RegexpField("f3", 3),
            new RegexLogFormat.RegexpField("f2", 2),
            new RegexLogFormat.RegexpField("date", 1, "my-date")
            );
